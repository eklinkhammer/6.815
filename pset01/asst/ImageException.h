...
class CouldNotReadFileException : public std::runtime_error {
 public:
  CouldNotReadFileException() : std::runtime_error("Could not read the file.") {}
};

class CouldNotWriteFileException : public std::runtime_error {
 public:
  CouldNotWriteFileException() : std::runtime_error("Could not write the file.") {}
};
