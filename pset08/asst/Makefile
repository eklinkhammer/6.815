...
$(EXECUTABLE): $(BUILD_DIR)/a8_main.o $(BUILD_DIR)/blending.o $(BUILD_DIR)/panorama.o $(BUILD_DIR)/homography.o $(BUILD_DIR)/basicImageManipulation.o $(BUILD_DIR)/filtering.o $(BUILD_DIR)/Image.o $(BUILD_DIR)/lodepng.o
	$(CXX) $(BUILD_DIR)/a8_main.o $(BUILD_DIR)/blending.o $(BUILD_DIR)/panorama.o $(BUILD_DIR)/homography.o $(BUILD_DIR)/basicImageManipulation.o $(BUILD_DIR)/filtering.o $(BUILD_DIR)/Image.o $(BUILD_DIR)/lodepng.o -o $(EXECUTABLE)
	mkdir -p $(OUTPUT)
...
$(BUILD_DIR)/a8_main.o: a8_main.cpp blending.h filtering.h panorama.h homography.h basicImageManipulation.h Image.h ImageException.h  lodepng.h messageassert.h matrix.h
	mkdir -p $(BUILD_DIR)
	$(CXX) -c a8_main.cpp -o $(BUILD_DIR)/a8_main.o

$(BUILD_DIR)/blending.o: blending.cpp blending.h panorama.h homography.h Image.h basicImageManipulation.h ImageException.h lodepng.h messageassert.h matrix.h
	mkdir -p $(BUILD_DIR)
	$(CXX) -c blending.cpp -o $(BUILD_DIR)/blending.o
